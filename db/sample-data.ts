...
const sampleData = {
  ...
  products: [
    ...
    },
    {
      ...
      category: "Refurbished Laptop",
      description:
        "Barely used and in excellent condition with no scratches, comes with charger",
      images: [
        "/images/sample-products/microsoft-surface.webp",
        "/images/sample-products/microsoft-surface-2.webp",
      ],
      price: 265.99,
      brand: "Microsoft",
      condition: "Mint",
